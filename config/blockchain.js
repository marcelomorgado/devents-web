module.exports = {
  development: {
    ...
    simulatorBlocktime: 1 // Specify blockTime in seconds for automatic mining. Default is 0 and no auto-mining.
  },
  testnet: {
    deployment: {
      accounts: [
        {
          "mnemonic": "fringe advance garbage ordinary tape about drive never amused clip trick aunt"
        }
      ],
      host: "ropsten.infura.io/v3/de8c7430c7a04499aa9c0fa77c654652",
      port: false,
      protocol: 'https',
      type: "rpc"
    }
